...
router.post('/', function (req, res) {
    ...
    let newItem = {
        ...
        item: req.body.item, // value of `item` get from POST req
        price: req.body.price, // value of `price` get from POST req
...
// for that we get `id` and `item` from api end-point of item to update
router.put('/:id', function (req, res) {
    ...
    if (found) {
        let updated = {
            id: found.id,
            item: req.body.item, // set value of `item` get from req
            price: req.body.price, // set value of `price` get from req
